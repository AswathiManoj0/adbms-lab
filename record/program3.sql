...
6.List employee name, job, salary, grade and department name for all except
clerk. Sort on salary descending order..
...
7. List the following details for all employees who earn 36000 a year or who
are clerk.
